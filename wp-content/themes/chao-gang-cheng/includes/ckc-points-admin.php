 ...
 * 1. 選單
 *
 * 後台選單整理：收整到「折價券點數」頂層選單（ckc-coupons.php 註冊，
 * slug ckc-coupon-center）底下，優先權 23（緊接在折價券管理 22 之後）。
 * ============================================================ */
add_action( 'admin_menu', 'ckc_pts_register_menu', 23 );
function ckc_pts_register_menu() {
    add_submenu_page( 'ckc-coupon-center', '整體總覽',   '整體總覽',
        'manage_woocommerce', 'ckc-points-admin',    'ckc_pts_page_overview' );
    add_submenu_page( 'ckc-coupon-center', '會員點數',   '會員點數',
        'manage_woocommerce', 'ckc-points-members',  'ckc_pts_page_members' );
    add_submenu_page( 'ckc-coupon-center', '異動紀錄',   '異動紀錄',
        'manage_woocommerce', 'ckc-points-log',      'ckc_pts_page_log' );
    add_submenu_page( 'ckc-coupon-center', '批量發放',   '批量發放',
        'manage_woocommerce', 'ckc-points-batch',    'ckc_pts_page_batch' );
    add_submenu_page( 'ckc-coupon-center', '發放設定',   '發放設定',
